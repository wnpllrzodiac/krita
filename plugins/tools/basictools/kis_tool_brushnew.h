...
class KisToolBrushNew : public KisToolFreehand
{
    Q_OBJECT
...
public:
    KisToolBrushNew(KoCanvasBase * canvas);
    ~KisToolBrushNew() override;
...
class KisToolBrushNewFactory : public KisToolPaintFactoryBase
{
...
public:
    ...
    KisToolBrushNewFactory(const QString &id)
